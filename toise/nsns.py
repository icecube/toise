...
class NSNS(object):
    def __init__(self, distance_mpc=10):
        ...
        self.interp = interp1d(
            np.log10(self.E),
            np.log10(self.fluence),
            bounds_error=False,
            fill_value="extrapolate",
        )
        self.distance_factor = 10.0**2 / distance_mpc**2
        self.merger_timescale = (
            30 * 24 * 3600
        )  # duration for which fluence is given / assume const in this timerange
