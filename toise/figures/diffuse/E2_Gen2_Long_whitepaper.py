...
def diffuse_sensitivity_uhe():
    ...
    GRAND_200k_10 = np.loadtxt(os.path.join(os.path.dirname(__file__),'data_gen2_limit_figure/sensitivity_grand.dat'))
    ...
    ara_4year_E, ara_4year_limit, t1, t2 = np.loadtxt(os.path.join(os.path.dirname(__file__), 'data_gen2_limit_figure', "limit_a23.txt"), unpack=True)
    ...
    ara_4year = np.array((
    [1.00E+16,	175630.000],
    [3.16E+16,	10212.86886],
    [1.00E+17,	2455.358773],
    [3.16E+17,	911.435028],
    [1.00E+18,	562.1438179],
    [3.16E+18,	458.1482809],
    [1.00E+19,	446.5991481],
    [3.16E+19,	551.6137519],
    [1.00E+20,	776.9899926],
    [3.16E+20,	1203.450378],
    [1.00E+21,	2149.977731]
    ))
    ...
    # Diffuse Flux
    Heinze_band = np.loadtxt(os.path.join(os.path.dirname(__file__), "data_gen2_limit_figure/talys_neu_bands.out"))
    ...
    Heinze_evo = np.loadtxt(os.path.join(os.path.dirname(__file__), "data_gen2_limit_figure/talys_neu_evolutions.out"))
    ...
    vanVliet_max_1 = np.loadtxt(os.path.join(os.path.dirname(__file__), "data_gen2_limit_figure/MaxNeutrinos1.txt"))
    vanVliet_max_2 = np.loadtxt(os.path.join(os.path.dirname(__file__), "data_gen2_limit_figure/MaxNeutrinos2.txt"))
    ...
    vanVliet_reas = np.loadtxt(os.path.join(os.path.dirname(__file__), "data_gen2_limit_figure/ReasonableNeutrinos1.txt"))
    ...
    tde = np.loadtxt(os.path.join(os.path.dirname(__file__),"data_gen2_limit_figure/TDEneutrinos.txt"))
    tde[:,0] *= units.GeV
    ...
    ll_grb = np.loadtxt(os.path.join(os.path.dirname(__file__),"data_gen2_limit_figure/LLGRBneutrinos.txt"))
    ll_grb[:,0] *= units.GeV
    ...
    pulsars = np.loadtxt(os.path.join(os.path.dirname(__file__),"data_gen2_limit_figure/Pulsar_Fang+_2014.txt"))
    pulsars[:,0] *= units.GeV
    ...
    clusters = np.loadtxt(os.path.join(os.path.dirname(__file__),"data_gen2_limit_figure/cluster_Fang_Murase_2018.txt"))
    ...
    grb_afterglow = np.loadtxt(os.path.join(os.path.dirname(__file__),"data_gen2_limit_figure/grb_ag_wind_optimistic.dat"))
    ...
    agn = np.loadtxt(os.path.join(os.path.dirname(__file__),"data_gen2_limit_figure/agn_murase.dat"),delimiter=',')
    ...
    #         ax.plot(anita_limit_old[:, 0] / plotUnitsEnergy, anita_limit_old[:, 1] / plotUnitsFlux, color='darkorange')
            if energyBinsPerDecade == 2:
                ...
                ax.annotate('ANITA I-IV',
                            xy=(6.06e9, 8.1e-7), xycoords='data',
                            horizontalalignment='left', color='darkorange',fontsize=legendfontsize)
