...
def sparse_hese_veto_plot(ax, f):
    ...
    style = dict(ls='None', markeredgecolor='None', markersize=5, capsize=0., linewidth=1)
    ax.axhline(1, color='grey', lw=0.5)
    ax.errorbar(npe, f['arr_1'], f['arr_4'], label='No veto', marker='o', color='k', **style)
    
    
    line = ax.errorbar(npe, f['arr_3'], f['arr_6'], label='125 m veto', marker='^', **style)[0]
    ax.plot(*fit(f['arr_3'], f['arr_6'], (10**3.48, 1e4)), color=line.get_color(), ls='--')


    line = ax.errorbar(npe, f['arr_2'], f['arr_5'], label='250 m veto', marker='s', **style)[0]
    ax.plot(*fit(f['arr_2'], f['arr_5'], (10**3.5, 10**4.7)), color=line.get_color(), ls='--')
...
def sparse_veto():
    ...
    line = ax.errorbar(npe, f['arr_3'], f['arr_6'], label='Single-spaced veto', marker='^', **style)[0]
    ax.plot(*fit(f['arr_3'], f['arr_6'], (10**3.48, 1e4)), color=line.get_color(), ls='--')
