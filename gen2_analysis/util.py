...
def refresh_data_tables(icecube_password=os.environ.get('ICECUBE_PASSWORD', None)):
    ...
    cwd = data_dir
    check_call(['curl', '--fail', '-u', 'icecube:'+icecube_password, '-O',
                'http://convey.icecube.wisc.edu/data/user/jvansanten/projects/2015/gen2_benchmark/data/archive.tar.gz'], cwd=cwd)
